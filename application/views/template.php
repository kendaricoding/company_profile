...
<head>
  ...
  <!-- Favicons -->
  <link href="<?php echo base_url();?>assets/kendaricoding/img/favicon.png" rel="icon">
  <link href="<?php echo base_url();?>assets/kendaricoding/img/apple-touch-icon.png" rel="apple-touch-icon">
    ...
    <div class="container-fluid">
      ...
      <div class="row justify-content-center">
        <div class="col-xl-9 d-flex align-items-center">
          ...
          <a href="index.html" class="logo mr-auto"><img src="<?php echo base_url(); ?>assets/kendaricoding/img/logo.png" alt="" class="img-fluid"></a>
          ...
          <a href="#about" class="get-started-btn scrollto">Daftar</a>
        </div>
      </div>
    ...
    <div class="container-fluid" data-aos="fade-up">
      <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1><?= $data_judul['tulisan_isi'] ?></h1>
          <h2><?= $data_deskripsi['tulisan_isi'] ?></h2>
